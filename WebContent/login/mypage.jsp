...
%>
            ...
            <!-- 사진 초기화-->
            <button type="button" class="remove_img btn btn-primary" onClick="location.href='mypage_image.jsp?filedel=no'" >사진 삭제</button>
         </div>
         ...
         <button type="button" class="moveto_passwd btn btn-primary" onClick="location.href='updateinfo.jsp'" >정보 변경</button>
      </div>
